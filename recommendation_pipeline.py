...
# Load các file dữ liệu đã có
reranked_df = pd.read_parquet("output/inference/inference_results.parquet")
article_text_df = pd.read_parquet("output/parquet/articles.parquet")

# Chạy search
query = "long sleeve floral dress"
top_results = search_by_text(query, reranked_df, article_text_df, top_k=10)
